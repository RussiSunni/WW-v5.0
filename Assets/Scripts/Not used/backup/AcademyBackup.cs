...
// public class AcademyBackup : MonoBehaviour
// {
//     Camera camera;
...
//         blackPanelColour = blackPanel.color;
//     }
...
//             blackPanelColour.a = 1;
//             blackPanel.color = blackPanelColour;
...
//         if (cameraPos.z == -5.4f && cameraPos.x == 0f && cameraPos.y == 12f)
//         {
//             // first Fairy interaction - sceneOne
...
//     public void OKCard()
//     {
//         if (Mathf.Approximately(cameraPos.z, -10.8f) && Mathf.Approximately(cameraPos.x, -5.4f) && cameraPos.y == 12f)
//         {
//             cameraPos.y = 2f;
//             camera.transform.position = new Vector3(cameraPos.x, cameraPos.y, cameraPos.z);
//             dialogue.text = "";
//         }
//         else if (Mathf.Approximately(cameraPos.z, -10.8f) && Mathf.Approximately(cameraPos.x, 5.4f) && cameraPos.y == 12f)
//         {
//             cameraPos.y = 2f;
//             camera.transform.position = new Vector3(cameraPos.x, cameraPos.y, cameraPos.z);
//             dialogue.text = "";
